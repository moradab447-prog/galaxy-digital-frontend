        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="lg:col-span-3">
            ...
            <div className="mt-6 bg-gray-100 rounded-3xl overflow-hidden h-64 relative">
              <iframe title="Galaxy Digital Agadir" src="https://maps.google.com/maps?q=Immeuble+Oum+Waraka+Al+Houda+Agadir&t=&z=16&ie=UTF8&iwloc=&output=embed" className="w-full h-full border-0" allowFullScreen loading="lazy" />
            </div>
          </motion.div>
        </div>
      </div>
